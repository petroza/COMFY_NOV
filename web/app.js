...
const formatPresets={hd_landscape:{w:1280,h:704},fhd_landscape:{w:1920,h:1088},hd_portrait:{w:704,h:1280},fhd_portrait:{w:1088,h:1920},square:{w:1024,h:1024},square_2000:{w:1984,h:1984},classic_4_3:{w:1472,h:1088},classic_3_4:{w:1088,h:1472}};
...
// Staré i nové rozměry vedou na stejný preset: LTX z 720 stejně udělá 704
// a z 1080 udělá 1088, takže dřív uložené joby se mají poznat jako HD/FHD,
// ne spadnout na "Custom".
function detectFormatKey(w,h){w=+w||0;h=+h||0;if(w===1280&&(h===720||h===704))return'hd_landscape';if(w===1920&&(h===1080||h===1088))return'fhd_landscape';if((w===720||w===704)&&h===1280)return'hd_portrait';if((w===1080||w===1088)&&h===1920)return'fhd_portrait';if((w===1440||w===1472)&&(h===1080||h===1088))return'classic_4_3';if((w===1080||w===1088)&&(h===1440||h===1472))return'classic_3_4';if(w===1024&&h===1024)return'square';if((w===2000||w===1984)&&(h===2000||h===1984))return'square_2000';return'custom'}
