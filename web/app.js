...
let apiBackoffUntil=parseInt((()=>{try{return localStorage.getItem('pz_comfy_429_until')||'0'}catch(e){return '0'}})(),10)||0;
let bulkUploadActive=false;
const BULK_UPLOAD_DELAY_MS=4000;
function mark429(){apiBackoffUntil=Date.now()+180000;try{localStorage.setItem('pz_comfy_429_until',String(apiBackoffUntil));}catch(e){}const st=$('stats');if(st)st.innerHTML='<span class="chip bad">Forpsi 429: pauza obnovování 3 min</span>';}
